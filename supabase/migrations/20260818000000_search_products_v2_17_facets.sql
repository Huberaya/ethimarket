-- Migration: 20260818000000_search_products_v2_17_facets.sql
-- Description: High-Performance PostgreSQL 17-Facet Search RPC with GIN, pg_trgm and Haversine Distance

CREATE EXTENSION IF NOT EXISTS "pg_trgm";
CREATE EXTENSION IF NOT EXISTS "unaccent";

-- 1. Optimized GIN Indexes for all 17 facets
...
-- 2. PostgreSQL search_products_v2 RPC Function
