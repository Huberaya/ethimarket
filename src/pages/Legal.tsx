...
const LEGAL_CONTENT: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  '/conditions-utilisation': {
    ...
    sections: [
      ...
      { heading: '4. Utilisation de la plateforme', body: "EthiMarket met en relation acheteurs et producteurs. La plateforme agit comme intermédiaire technique et n'est partie ni au contrat de vente ni au règlement. Le règlement s'effectue par virement bancaire direct entre l'acheteur et le producteur à réception de facture, ou par carte via notre prestataire de paiement Stripe lorsque cette option est proposée. La commission d'EthiMarket est de 5% sur les ventes réalisées." },
      ...
      { heading: '6. Obligations des acheteurs', body: "Les acheteurs s'engagent à payer les commandes confirmées selon les modalités convenues (virement à réception de facture ou paiement en ligne) et à respecter les conditions de chaque producteur (MOQ, délais). L'acheteur confirme la réception de la marchandise sur la plateforme." },
      { heading: '7. Paiements et escrow', body: "Deux modalités de règlement existent : (a) le virement bancaire direct de l'acheteur au producteur, à réception de la facture émise par ce dernier — EthiMarket n'encaisse alors aucun fonds ; (b) le paiement par carte via Stripe, prestataire de paiement agréé, lorsque cette option est activée. Le bon de commande généré par la plateforme matérialise l'accord issu du devis accepté." },
      { heading: '8. Litiges et réclamations', body: "En cas de litige, l'acheteur peut ouvrir un signalement directement sur la commande concernée (statut « litige ») dans un délai de 14 jours suivant la livraison. EthiMarket facilite la résolution amiable entre les parties via la messagerie de la plateforme mais ne détient pas de fonds. À défaut d'accord amiable, le litige relève des juridictions compétentes." },
  ...
  '/confidentialite': {
    ...
    sections: [
      ...
      { heading: 'Vos droits (RGPD)', body: "Conformément au RGPD, vous disposez des droits suivants : droit d'accès, de rectification, d'effacement, de limitation, de portabilité et d'opposition. Vous pouvez exercer directement vos droits d'export et de suppression depuis votre tableau de bord (Paramètres → Confidentialité & compte), ou nous contacter via le formulaire de contact de la plateforme." },
      ...
      { heading: 'Sécurité des données', body: "Vos données sont chiffrées en transit (TLS) et hébergées chez Supabase (infrastructure AWS, région Union européenne) avec chiffrement au repos. L'accès aux données de production est strictement limité. Les secrets d'exploitation sont stockés chiffrés (coffre-fort applicatif)." },
      ...
      { heading: 'Contact DPO', body: "Pour toute question relative à la protection de vos données, utilisez le formulaire de contact de la plateforme (rubrique Contact). Les coordonnées postales du responsable de traitement figureront dans les mentions légales dès l'immatriculation de la société éditrice." },
    ],
  },
  '/cookies': {
    ...
    sections: [
      ...
      { heading: 'Cookies essentiels', body: "Ces traceurs sont nécessaires au fonctionnement de la plateforme : jeton de session d'authentification (Supabase Auth) et préférence de langue. Ils ne peuvent pas être désactivés." },
      { heading: 'Cookies de mesure d\'audience', body: "À ce jour, EthiMarket n'utilise aucun cookie de mesure d'audience tiers. Si un outil d'analyse est déployé à l'avenir, cette politique sera mise à jour et votre consentement sera recueilli au préalable." },
      ...
      { heading: 'Tableau des cookies', body: "Jeton d'authentification Supabase (stockage local) : essentiel, expire selon la session. Préférence de langue « ethimarket_locale » (stockage local) : personnalisation, conservée jusqu'à suppression par l'utilisateur. Aucun cookie publicitaire ou de suivi tiers n'est déposé." },
    ],
  },
};
