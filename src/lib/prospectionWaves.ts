...
export function getWaves(kind: 'buyer' | 'producer', phase: number): Wave[] {
  if (kind === 'buyer') {
    if (phase === 1) return [
      ...
      { week: 'Semaines 5-6', label: 'Brest, Tours, Caen & Laval', cities: ['Brest', 'Tours', 'Caen', 'Quimper', 'La Rochelle', 'Dinard', 'Dol-de-Bretagne', 'Avranches', 'Laval', 'Saint-Fort', 'Saint-Brieuc', 'Plérin', 'Trégueux', 'Saint-Cast-le-Guildo', 'Fréhel', 'Pédernec', 'Guingamp', 'Plouha'], rationale: 'Le grand Ouest élargi : brûleries historiques (Léon, Coïc, El Cafecito), Kafeta (7 torréfactions d\u2019un coup), Laval (Mayenne Bio Soleil, 6 magasins), bassin briochin (La Gambille, 5 magasins) et côte d\u2019émeraude — e-mail d\u2019abord, tournée si réponse.' },
